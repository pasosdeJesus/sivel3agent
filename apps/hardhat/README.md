...
This directory contains the Solidity smart contracts for the 
platform, managed with Hardhat. These contracts handle ...
...
* Prefer a multisig
* For a project with only one owner prefer a contract with transferOwner 
  https://metaschool.so/articles/account-ownership-in-solidity
  and setBackendAddress 
